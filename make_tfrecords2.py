...
def encoder_proc(wav_filename, noisy_path, ref_path, out_file, wav_canvas_size):
    ...
    ref_filename   = os.path.join(ref_path, wav_fullname)
    ...
    with open(opts.cfg) as cfh:
        ...
        for dset_i, (dset, dset_desc) in enumerate(cfg_desc.items()):
            ...
            for m, wav_file in enumerate(wav_files):
                ...
                sys.stdout.flush()
                encoder_proc(wav_file, noisy_dir, ref_dir, out_file, 2 ** 14)
        out_file.close()
